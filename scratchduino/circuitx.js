(function (ext) {
    ...
    function appNotConnected() {
        ...
        $('body').append("<div id=\'app-not-connected-popup\'\n     style=\'position:fixed;top:0;right:0;bottom:0;left:0;background:rgba(0,0,0,0.8);display: flex; justify-content: center; align-items: center;\'>\n\n\n    <div style=\'color:gray;  margin:10%; background:white;border-radius: 4px; box-shadow:0 2px 2px rgba(0,0,0,0.5); padding:20px;text-align: center;\'>\n\n        <span style=\'color:#F44336; font-size:150%;\'>App Not Connected</span>\n\n        <hr style=\'margin: 10px 0;\'/>\n\n\n        Please install and lunch the app by <a\n            href=\'https://chrome.google.com/webstore/detail/dbhfnkcnljcbbpocflmbfcobkmagpgpf\'\n            target=\'_blank\'\n            style=\'background: #4CAF50; color: white; font-weight: bold; text-transform: uppercase; padding: 2px 20px; border-radius: 4px; border-bottom: 2px solid #2E7D32; cursor: pointer;\'>clicking here</a>,\n\n        <br/>\n\n        and check back here.\n\n        <img src=\"https://media.giphy.com/media/26xBMKr8SJsuikHcI/giphy.gif\"\n             style=\'display: block;height:100px;margin:20px auto\'>\n\n    </div>\n</div>");
    }
